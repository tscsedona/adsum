...
<div id="page-container" class="row-fluid">
		...
		<div class="attendeeStatusLogs index">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
				<tr>
											...
											<th><?php echo $this->Paginator->sort('logged_by'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($attendeeStatusLog['Attendee']['id'], array('controller' => 'attendees', 'action' => 'view', $attendeeStatusLog['Attendee']['id'])); ?>
		</td>
		<td>
